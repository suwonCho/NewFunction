...
namespace PLCModule
{
	...
	public class frmPLCMonitor : System.Windows.Forms.Form
	{
		...
		public frmPLCMonitor(clsPLCModule comm)
		{
			//
		...
		private void InitializeComponent()
		{
			...
			this.lblStatus.Location = new System.Drawing.Point(237, 17);
			...
			this.grpMelsec.Size = new System.Drawing.Size(317, 107);
			...
			this.txtPlcType.Size = new System.Drawing.Size(135, 23);
			...
			this.Grid.Size = new System.Drawing.Size(318, 234);
			...
			this.lblR.Location = new System.Drawing.Point(294, 88);
			this.lblR.Name = "lblR";
		...
		private void frmTest_Load(object sender, System.EventArgs e)
		{
			...
			Ch_ConnectionStatus(Comm.isConnected);
			isOpenForm = true;

			this.Text += " v" + Assembly.GetAssembly(Type.GetType("PLCModule.clsPLCModule")).GetName().Version.ToString();
		...
		private delegate void delCh_ConnectionStatus(bool bolStatus);
