...
namespace AutoUpdater.AutoUpdateServer_Web {
    using System;
    ...
    public partial class AutoUpdateServer : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback ColumnAddedChkOperationCompleted;
        ...
        public AutoUpdateServer() {
            this.Url = global::AutoUpdater.Properties.Settings.Default.AutoUpdater_AutoUpdateServer_Web_AutoUpdateServer;
        ...
        /// <remarks/>
        public event ColumnAddedChkCompletedEventHandler ColumnAddedChkCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/ColumnAddedChk", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public void ColumnAddedChk(string updateType, string[] Add_Cols, string[] Add_Types, object[] dValue) {
            this.Invoke("ColumnAddedChk", new object[] {
                        updateType,
                        Add_Cols,
                        Add_Types,
                        dValue});
        ...
        /// <remarks/>
        public void ColumnAddedChkAsync(string updateType, string[] Add_Cols, string[] Add_Types, object[] dValue) {
            this.ColumnAddedChkAsync(updateType, Add_Cols, Add_Types, dValue, null);
        }
        
        /// <remarks/>
        public void ColumnAddedChkAsync(string updateType, string[] Add_Cols, string[] Add_Types, object[] dValue, object userState) {
            if ((this.ColumnAddedChkOperationCompleted == null)) {
                this.ColumnAddedChkOperationCompleted = new System.Threading.SendOrPostCallback(this.OnColumnAddedChkOperationCompleted);
            }
            this.InvokeAsync("ColumnAddedChk", new object[] {
                        updateType,
                        Add_Cols,
                        Add_Types,
                        dValue}, this.ColumnAddedChkOperationCompleted, userState);
        }
        
        private void OnColumnAddedChkOperationCompleted(object arg) {
            if ((this.ColumnAddedChkCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.ColumnAddedChkCompleted(this, new System.ComponentModel.AsyncCompletedEventArgs(invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")]
    public delegate void ColumnAddedChkCompletedEventHandler(object sender, System.ComponentModel.AsyncCompletedEventArgs e);
