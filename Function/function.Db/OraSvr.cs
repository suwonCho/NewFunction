...
namespace function.Db
{
    ...
    public class OraSvr
    {
        ...
        /// 서버 연결 클래스
        /// </summary>
        DB_POP_SERVICE.DB_POP_SERVICE Svr;
        ...
        public OraSvr(string DBUrl, string pop_cd, Log log)
        {
        ...
        public DataTable ExcuteTable_RtnTable(DateTime dTime, enDBExcuteType ExcuteType, string Query, List<OracleParameter> param, DataTable baseDt = null, enShowQueryResultType rType = enShowQueryResultType.Count)
        {
            ...
            try
            {
                ...
                if(Log != null) Log.WLog($"[IPAddress]{dr["IPAddress"]} [POP_CD]{dr["POP_CD"]} [DateTime]{dr["DateTime"]} [ExcuteType]{ExcuteType.ToString()}\r\n{dr["Query"]}\r\n\t[Params]{dr["Params"]}\r\n");
